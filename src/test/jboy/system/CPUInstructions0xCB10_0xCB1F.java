...
class CPUInstructions0xCB10_0xCB1F {
    ...
    void rl_b_test() {
        ...
        assertEquals(CPU.FLAG_ZERO | CPU.FLAG_CARRY, cpu.getF(), "The ZERO and CARRY flag should be set.");
    ...
    @Test
    void rl_hlp_test() {
        rom[0x7000] = 0x80; // This is the value that HL will point to.
        ...
        assertEquals(CPU.FLAG_ZERO | CPU.FLAG_CARRY, cpu.getF(), "The ZERO and CARRY flag should be set.");
        assertEquals(0x105, cpu.getPC(), "PC should equal 0x104.");

        cpu.setPC(0x100);
        cpu.resetFlags(CPU.FLAG_ZERO | CPU.FLAG_SUB | CPU.FLAG_HALF | CPU.FLAG_CARRY);

        rom[0x7000] = 0x11; // This is the value that HL will point to.
    ...
    void rr_hlp_test() {
        ...
        rom[0x7000] = 0x8A; // This is the value that HL will point to.
